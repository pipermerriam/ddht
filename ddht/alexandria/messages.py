...
from ddht.alexandria.sedes import PingSedes, PongSedes
...
TAlexandriaMessage = TypeVar("TAlexandriaMessage", bound=Type[AlexandriaMessage[Any]])


def register(message_class: TAlexandriaMessage) -> TAlexandriaMessage:
